...
Background_Image = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'background.png'))
Movies_Button = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'MoviesB.png'))
Movies_ButtonS = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'MoviesBS.png'))
TvShows_Button = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'TvShowsB.png'))
TvShows_ButtonS = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'TvShowsBS.png'))
AddMovie_Button = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'AddMovieB.png'))
AddMovie_ButtonS = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'AddMovieBS.png'))
AddShow_Button = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'AddShowB.png'))
AddShow_ButtonS = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'AddShowBS.png'))
Settings_Button = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'SettingsB.png'))
Settings_ButtonS = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'SettingsBS.png'))
Quit_Button = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'QuitB.png'))
Quit_ButtonS = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'QuitBS.png'))
NoMedia = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'NoVideo.png'))
# FRAMES
Frame1 = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'Frame.png'))
Frame1S = xbmcvfs.translatePath(os.path.join(
    'special://home/addons/' + _addon_id_ + _images_, 'FrameS.png'))
...
def PopMovies(self):
    ...
    try:
        ...
        pass
    UserTitle = pyxbmct.Label(User + '\'S MOVIES ', textColor='0xFF02bcf5',
                              font='font60', alignment=pyxbmct.ALIGN_CENTER)
#############################################################
########## Function To Call That Starts The Window ##########


def MainWindow(profile):
    global User
    User = profile
    window = Main('Flex')
    window.doModal()
...
def openviewer(self, MovieID, User):
    viewer.MainWindow(self, 'Movie|'+MovieID, User)
    self.close()


def TvShows(self, User):
...
def SearchMovie(self, User):
    section = ['[COLOR red][B]Search Movie[/B][/COLOR]', '[COLOR white][B]Top Movies[/B][/COLOR]',
               '[COLOR white][B]Cinema Movies[/B][/COLOR]', '[COLOR white][B]People Watching[/B][/COLOR]']
    links = ['SEARCH', 'TOP', 'CINEMA', 'WATCHING']
    select = dialog.select(
        '[B][COLOR red]W[COLOR white]hat Would You Like To Do?[/COLOR][/B]', section)
    if select < 0:
        quit()
    url = links[select]
    if 'SEARCH' in url:
        ...
        url = 'https://api.themoviedb.org/3/discover/movie?api_key=' + \
            TMDBAPI + '&with_release_type=2|3&region=US'
        SearchTMDB.listwindow('MOVIE|'+url, User)
        self.close()
...
def SearchTV(self, User):
    section = ['[COLOR red][B]Search Tv Show[/B][/COLOR]',
               '[COLOR white][B]Top Tv Shows[/B][/COLOR]', '[COLOR white][B]Shows Airing Today[/B][/COLOR]']
    ...
    if 'SEARCH' in url:
        string = ''
        keyboard = xbmc.Keyboard(
            string, '[COLOR white][B]Search Which Tv Show?[/B][/COLOR]')
        keyboard.doModal()
        if keyboard.isConfirmed():
            string = keyboard.getText()
            if len(string) > 1:
...
class Main(pyxbmct.AddonFullWindow):
    ...
    def __init__(self, title='Flex'):
        ...
        tick(self)
        self.connect(self.button2, lambda: TvShows(self, User))
    ...
    def set_active_controls(self):
        ...
        self.button20 = pyxbmct.Button(
            '',   focusTexture=Frame1S,   noFocusTexture=Frame1)
        self.placeControl(self.button20, 43, 42, 30, 7)
        self.button21 = pyxbmct.Button(
            '',   focusTexture=Frame1S,   noFocusTexture=Frame1)
