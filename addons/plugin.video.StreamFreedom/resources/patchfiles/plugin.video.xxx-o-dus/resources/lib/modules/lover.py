...
#     'special://home/addons', 'repository.StreamArmy'))
#
#
# def checkupdates():
...
#     c = re.findall(
#         '<addon\s+id="plugin.video.xxx-o-dus".+?version="(.*?)"', b, flags=re.DOTALL)[0]
#     if a == c:
#         pass
#     else:
#         dialog.ok("[COLOR red][B]WARNING[/B][/COLOR]",
#                   "[COLOR yellow]None Supported Version Of XXX-O-DUS Or Addon Out Of Date, Use Official Version From Stream Army Repo, You May Just Need To Update Your Addon[/COLOR]")
#         quit()
